...
ActiveRecord::Schema.define(version: 20151026145104) do
  ...
  add_index "calls", ["uid"], name: "index_calls_on_uid", using: :btree
  ...
  add_index "phone_numbers", ["sip_endpoint"], name: "index_phone_numbers_on_sip_endpoint", using: :btree
